...
const TaxVolunteerMBKMDetailPage = () => {
  const { id } = useParams();
  const router = useRouter();
  const { data: volunteer, isLoading } = useQuery<TaxVolunteerMBKMDetail>(
    `tax-volunteer/mbkm/${id}`
  );
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card>
        <HeaderTitle>Detail Data Relawan Pajak MBKM</HeaderTitle>
...
export default TaxVolunteerMBKMDetailPage;
